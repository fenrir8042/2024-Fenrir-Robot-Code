...
public final class Constants {
  ...
  public static class RediktorConstans {
    public static final int rediktorPort = 45;
    public static final int rediktor2Port = 52;
  }
  ...
  public static class ShooterIntake {
    public static final int shooterIntakeCimPort = 111;
  }

  public static class ShooterConstants {
    public static final int shooterRightPort = 0;
    public static final int shooterLeftPort = 0;
    public static final int transMitterPort = 0;
  }
