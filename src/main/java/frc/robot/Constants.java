...
public final class Constants {
  ...
  public static class ClimbConstants {
    public static final int leftClimbPort = 45;
    public static final int rightClimbPort = 52;
  }
  ...
  public static class ArmConstants {
    ...
    public static final int Spark = 28;
    public static final int VictorSPX = 9;
    public static int centerVictorSPX;
